...
const Banner = () => {
    return (
        <div className='flex  px-80 bg-cyan-100'>
            <div className='h-4/5 my-auto'>
                ...
                <button className='bg-blue-500 pt-3  pb-3 pl-5 pr-5 rounded-md mt-6'> <Link className='font-semibold text-white'>Get Started</Link> </button>
            </div>
